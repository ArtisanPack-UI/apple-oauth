 ...
 *     is where the private_key and client_secret encryption lives, matching
 *     the real framework's behavior) and stores the sanitized value.
 ...
 * AppleOAuth service provider (which registers its sanitize callbacks during
 * `$this->app->booted()`).
 *
 * @since 1.0.0
 */
